...
class ThumbnailWidgetItem(QtGui.QListWidgetItem):
    def __init__(self, filepath, thumbnailWidth, thumbnailHeight, parent=None):
        ...
        self.thumbnailLabel.setPixmap(QtGui.QPixmap(self.thumbnailImage.scaled(self.thumbnailWidth, self.thumbnailHeight, QtCore.Qt.KeepAspectRatio)))
...
if __name__ == '__main__':
    ...
    thumbnailWidgetItem = ThumbnailWidgetItem("E:\\Programming\\Pycharm Projects\\uAuction\\resources\\img\\logo.png", 60, 60)
